...
class Barcode {
  ...
  const Barcode({
    ...
    this.url,
    this.wifi,
    this.supplementalValue,
    this.supplementalConfidence,
    this.supplementalSource,
  });
  ...
  factory Barcode.fromNative(Map<Object?, Object?> data) {
    ...
    return Barcode(
      ...
      supplementalValue: data['supplementalValue'] as String?,
      supplementalConfidence:
          (data['supplementalConfidence'] as num?)?.toDouble(),
      supplementalSource: data['supplementalSource'] as String?,
    );
  }
  ...
  /// A separately recognized UPC/EAN supplement.
  final String? supplementalValue;

  /// Confidence reported by the native supplement recognizer.
  final double? supplementalConfidence;

  /// The native supplement source, such as `vision_barcode` or `vision_ocr`.
  final String? supplementalSource;
