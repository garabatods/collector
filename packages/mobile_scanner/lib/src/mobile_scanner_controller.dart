...
class MobileScannerController extends ValueNotifier<MobileScannerState> {
  ...
  MobileScannerController({
    ...
    this.autoZoom = false,
    this.initialZoom,
    this.comicSupplementOcrEnabled = false,
  }) : detectionTimeoutMs =
  ...
  /// Enables on-device OCR for five-digit comic barcode supplements on Apple
  /// platforms. Other platforms ignore this option.
  final bool comicSupplementOcrEnabled;
  ...
  Future<void> start({
    ...
    final options = StartOptions(
      ...
      comicSupplementOcrEnabled: comicSupplementOcrEnabled,
    );
